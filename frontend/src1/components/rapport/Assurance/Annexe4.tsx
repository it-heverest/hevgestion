  ...
  const downloadPDF = async () => {
    if (reportRef.current) {
      ...
      setTimeout(async () => {
        ...
        pdf.save("etat_paiements_hors_sinistre.pdf");
    ...
    <div className="min-h-screen bg-gray-100 p-8 font-sans text-xs text-black">
      <div className="w-3/4 max-w-[210mm] mx-auto mb-6 flex justify-between items-center bg-white p-4 rounded shadow">
        <h1 className="text-xl font-bold text-gray-700 flex items-center gap-2">
          ...
          État des Paiements ou Distributions Hors Sinistre
        </h1>
      ...
      >
        ...
        <div className="medium-gray py-2 text-center font-bold text-lg mb-6">
          TABLEAU
          <br />
          ETAT DES PAIEMENTS OU DISTRIBUTIONS HORS SINISTRE ET COMMISSIONS
          EFFECTUEES
        </div>
