...
// --- Composant Principal ---
// Page de séparation entre les sections du DSF (sommaire "II. NOTES
// STATISTIQUES ET DE SYNTHESES") — pas de données à éditer, juste le titre
// de section centré comme dans le modèle Excel.
const SectionDividerII: React.FC = () => {
  ...
  const downloadPDF = async () => {
    if (reportRef.current) {
      ...
      pdf.save("section_ii_notes_statistiques_et_syntheses.pdf");
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 p-8 font-sans text-xs text-black">
      ...
      <div className="w-3/4 max-w-[210mm] mx-auto mb-6 flex justify-between items-center bg-white p-4 rounded shadow">
        <h1 className="text-xl font-bold text-black flex items-center gap-2">
          ...
          II. Notes Statistiques et de Synthèses
        </h1>
        <button
            onClick={downloadPDF}
...
export default SectionDividerII;
