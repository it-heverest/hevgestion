  ...
  const downloadPDF = async () => {
    if (reportRef.current) {
      ...
      setTimeout(async () => {
        ...
        pdf.save("tableau_44a_sinistres_vie.pdf");
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 font-sans text-xs text-black">
      ...
      >
        ...
        {/* Page number */}
        <div className="text-center font-bold text-lg mb-4">44 A</div>
