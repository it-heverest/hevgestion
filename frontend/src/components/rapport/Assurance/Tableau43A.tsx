  ...
  const downloadPDF = async () => {
    if (reportRef.current) {
      ...
      setTimeout(async () => {
        ...
        pdf.save("tableau_43a_production_vie.pdf");
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 font-sans text-xs text-black">
      ...
      >
        ...
        {/* Page number */}
        <div className="text-center font-bold text-lg mb-4">43 A</div>
        ...
        <table className="w-full border-collapse border border-gray-400 text-[11px]">
          ...
          <tbody>
            ...
            <tr>
              <td className="border border-gray-400 p-1 pl-8">Mixte</td>
            ...
            <tr>
              <td className="border border-gray-400 p-1 pl-8">Epargne</td>
