  ...
  const downloadPDF = async () => {
    if (reportRef.current) {
      ...
      setTimeout(async () => {
        ...
        pdf.save("tableau_38_echeances_dettes.pdf");
    ...
    <div className="min-h-screen bg-gray-100 p-8 font-sans text-xs text-black">
      <div className="w-3/4 max-w-[297mm] mx-auto mb-6 flex justify-between items-center bg-white p-4 rounded shadow">
        <h1 className="text-xl font-bold text-black flex items-center gap-2">
          ...
          Tableau 38 - Échéances des Dettes
        </h1>
      ...
      >
        ...
        {/* Page number */}
        <div className="text-center font-bold text-lg mb-4">38</div>
        ...
        <div className="medium-gray py-2 text-center font-bold text-lg mb-6">
          ÉCHEANCES DES DETTES À LA CLÔTURE DE L'EXERCICE
        </div>
        ...
        <table className="w-full border-collapse border border-gray-400 text-[11px]">
          <thead>
            ...
            <tr className="medium-gray">
              ...
              <th className="border border-gray-400 p-1 text-center">
                Montant envers entreprises liées
              </th>
              <th className="border border-gray-400 p-1 text-center">
          ...
          <tbody>
            ...
            <tr>
              <td className="border border-gray-400 p-1 pl-8">
                Dettes pour espèces remises par les cédants
              </td>
            ...
            <tr>
              <td className="border border-gray-400 p-1 pl-8">
                Emprunts et autres dettes à plus d'un an
              </td>
            ...
            <tr className="dark-gray font-bold">
              <td className="border border-gray-400 p-2 pl-4">
                Totaux lignes 4, 8 et 22
              </td>
              <td className="border border-gray-400 p-2 text-center">23</td>
              <td className="border border-gray-400 p-2 text-right">0</td>
              <td className="border border-gray-400 p-2 text-right">0</td>
              <td className="border border-gray-400 p-2 text-right">0</td>
              <td className="border border-gray-400 p-2 text-right">0</td>
