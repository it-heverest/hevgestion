  ...
  const downloadPDF = async () => {
    if (reportRef.current) {
      ...
      setTimeout(async () => {
        ...
        pdf.save("detail_autres_provisions_techniques.pdf");
    ...
    <div className="min-h-screen bg-gray-100 p-8 font-sans text-xs text-black">
      <div className="w-3/4 max-w-[210mm] mx-auto mb-6 flex justify-between items-center bg-white p-4 rounded shadow">
        <h1 className="text-xl font-bold text-black flex items-center gap-2">
          ...
          Détail des Autres Provisions Techniques
        </h1>
      ...
      >
        ...
        <div className="medium-gray py-2 text-center font-bold text-lg mb-6">
          TABLEAU
          <br />
          DETAIL DES AUTRES PROVISIONS TECHNIQUES
        </div>
        ...
        <table className="w-full border-collapse border border-gray-400 text-[11px]">
          <thead>
            <tr className="medium-gray">
              <th className="border border-gray-400 p-2 text-left w-[25%]">
                Montant du sinistre couvert
              </th>
          ...
          <tbody>
            ...
            <tr className="dark-gray font-bold">
              <td className="border border-gray-400 p-2 pl-4" colSpan={3}>
                Total
              </td>
              <td className="border border-gray-400 p-2 text-right">0</td>
              <td className="border border-gray-400 p-2 text-right">0</td>
