  ...
  const renderRow = (row: ReserveRow, isTotal = false, bgClass = "") => (
    <tr key={row.id} className={bgClass}>
      ...
      <td className="border border-gray-400 p-1 text-right">
        {isEditing && !hasFormula(`note14.rows.${row.id}`) ? (
          <input
            type="number"
            value={row.yearN}
          ...
          <FormulaValue formulaKey={`note14.rows.${row.id}`} label={row.label}>
        ...
        <table className="w-full border-collapse border border-gray-400 text-[11px]">
          ...
          <tbody>
            ...
            <tr className="bg-gray-300 font-bold">
              ...
              <td className="border border-gray-400 p-1 text-right">
                {primes.yearN.toLocaleString("fr-FR").replace(/\u202F/g, " ")}
              </td>
              <td className="border border-gray-400 p-1 text-right">
                {primes.yearN1.toLocaleString("fr-FR").replace(/\u202F/g, " ")}
              </td>
              <td className="border border-gray-400 p-1 text-right">
            ...
            <tr className="bg-gray-300 font-bold">
              ...
              <td className="border border-gray-400 p-1 text-right">
                {reservesIndisponibles.yearN.toLocaleString("fr-FR").replace(/\u202F/g, " ")}
              </td>
              <td className="border border-gray-400 p-1 text-right">
                {reservesIndisponibles.yearN1.toLocaleString("fr-FR").replace(/\u202F/g, " ")}
              </td>
              <td className="border border-gray-400 p-1 text-right">
                {variationAbs(
