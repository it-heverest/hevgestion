        ...
        <table className="w-full border-collapse border border-gray-400 text-[11px]">
          ...
          <tbody>
            {rows.map((row, index) => (
              <tr key={row.id}>
                ...
                <td className="border border-gray-400 p-1 text-right font-medium">
                  {rowTotal(row).toLocaleString("fr-FR").replace(/\u202F/g, " ")}
                </td>
              </tr>
            ))}
            <tr className="font-bold bg-gray-300">
              ...
              <td className="border border-gray-400 p-1 text-right">{totals.precomptesAchats.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.principal.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.ccx.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.retenuesSource.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.autresPrelevements.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{grandTotal.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
            </tr>
          </tbody>
        </table>
      </div>
