        ...
        <table className="w-full border-collapse border border-gray-400 text-[11px] mb-6">
          <thead>
            <tr className="medium-gray">
              <th colSpan={6} className="border border-gray-400 p-1 text-center">
            ...
            <tr className="medium-gray">
              ...
              <th className="border border-gray-400 p-1">Ligne</th>
          ...
          <tbody>
            ...
            <tr className="font-bold">
              ...
              <td className="border border-gray-400 p-1 text-right">{totals.reinvestissement.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.base60.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.baseEffective.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.reductionsReportables.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
              <td className="border border-gray-400 p-1 text-right">{totals.montant.toLocaleString("fr-FR").replace(/\u202F/g, " ")}</td>
            </tr>
          </tbody>
        </table>
      </div>
