                    ...
                    {prevReport && (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-start leading-tight">
                                <span className="text-[10px] text-gray-500 uppercase font-bold">Précédent</span>
                    ...
                    {nextReport && (
                        ...
                        >
                            <div className="flex flex-col items-end leading-tight">
                                ...
                                <span className="text-sm font-semibold truncate max-w-[150px] text-gray-900">{nextReport.name}</span>
                            </div>
