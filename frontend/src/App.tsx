                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div>
                          <h1 className="text-lg font-semibold text-gray-900">
                            Revue Fiscale - Acc̬s Restreint
                          </h1>
                          <p className="text-sm text-gray-500">
                            Utilisateur avec acc̬s limit̩ - Revue Fiscale uniquement
                          </p>
                        </div>
                        <button
                          onClick={() => logout()}
                  ...
                  element={
                    <AllReports
                      ...
                      checkExistingDSF={async (
                        ...
                        try {
                          const notes =
                            await notesService.getNotesForFolder(folderId, true);
                          if (notes?.length) {
                      ...
                      onNormalGeneration={async () => {
                        ...
                        try {
                          ...
                          alert(
                            "Erreur lors de la g̩n̩ration de la DSF. Veuillez v̩rifier que la balance N est disponible.",
                          );
                        }
                      }}
                    />
